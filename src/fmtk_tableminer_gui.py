...
class FmtkTableMinerFrame (wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"FMTK TableMiner", pos=wx.DefaultPosition, size=wx.Size(
            1000, 1100), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        self.mnui_settings = wx.MenuItem(
            self.mnu_top, wx.ID_ANY, u"Settings...", wx.EmptyString, wx.ITEM_NORMAL)
        self.mnu_top.Append(self.mnui_settings)

        self.mnui_imgdir = wx.MenuItem(
            self.mnu_top, wx.ID_ANY, u"Set Image Directory...", wx.EmptyString, wx.ITEM_NORMAL)
        self.mnu_top.Append(self.mnui_imgdir)

        self.mnui_datadir = wx.MenuItem(
            self.mnu_top, wx.ID_ANY, u"Select Data Directory...", wx.EmptyString, wx.ITEM_NORMAL)
        self.mnu_top.Append(self.mnui_datadir)

        self.mnu_top.AppendSeparator()

        self.mnui_quit = wx.MenuItem(
            self.mnu_top, wx.ID_ANY, u"Quit Fmtk_TableMiner", wx.EmptyString, wx.ITEM_NORMAL)
        ...
        self.tbar_table = self.toolbar.AddTool(tb_TBL_BBOX, u"Set Table BoundingBox", wx.Bitmap(
            u"resources/tbl_tbar_table_40px.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, u"Set Table BoundingBox", wx.EmptyString, None)

        self.tbar_row_sep = self.toolbar.AddTool(tb_ROW_SEP, u"Row Separator", wx.Bitmap(
            u"resources/tbl_tbar_row-sep_40px.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, u"Row Separator", wx.EmptyString, None)

        self.tbar_col_sep = self.toolbar.AddTool(tb_COL_SEP, u"Column Separator", wx.Bitmap(
            u"resources/tbl_tbar_col-sep_40px.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, u"Column Separator", wx.EmptyString, None)

        self.tbar_del_sep = self.toolbar.AddTool(tb_DEL_SEP, u"Delete Separator", wx.Bitmap(
            u"resources/tbl_tbar_del-sep_40px.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, u"Delete Separator", wx.EmptyString, None)

        self.tbar_sel_cell = self.toolbar.AddTool(tb_SEL_CELL, u"Select Cell", wx.Bitmap(
            u"resources/tbl_tbar_cell_40px.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, u"Select Cell at Row/Col click", wx.EmptyString, None)

        self.toolbar.AddSeparator()

        self.tbar_img_sel_label = wx.StaticText(
            self.toolbar, wx.ID_ANY, u"Prev/Next Image:", wx.DefaultPosition, wx.DefaultSize, 0)
        self.tbar_img_sel_label.Wrap(-1)

        self.toolbar.AddControl(self.tbar_img_sel_label)
        self.tbar_prior_image = wx.Button(
            self.toolbar, wx.ID_ANY, u"<", wx.DefaultPosition, wx.Size(33, -1), 0)
        self.tbar_prior_image.SetToolTip(
            u"Move to PRIOR image by filename in the Settings’ designated image directory.")

        self.toolbar.AddControl(self.tbar_prior_image)
        self.tbar_next_image_btn = wx.Button(
            self.toolbar, wx.ID_ANY, u">", wx.DefaultPosition, wx.Size(33, -1), 0)
        self.tbar_next_image_btn.SetToolTip(
            u"Move to NEXT image by filename in the Settings’ designated image directory.")

        self.toolbar.AddControl(self.tbar_next_image_btn)
        self.toolbar.AddSeparator()

        self.tbar_zoom_label = wx.StaticText(
            self.toolbar, wx.ID_ANY, u"Zoom", wx.DefaultPosition, wx.DefaultSize, 0)
        self.tbar_zoom_label.Wrap(-1)

        self.toolbar.AddControl(self.tbar_zoom_label)
        tbar_zoom_sizeChoices = [u"10%", u"25%", u"50%", u"75%", u"100%",
                                 u"150%", u"200%", u"400%", wx.EmptyString, wx.EmptyString]
        self.tbar_zoom_size = wx.Choice(
            self.toolbar, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, tbar_zoom_sizeChoices, 0)
        self.tbar_zoom_size.SetSelection(4)
        self.toolbar.AddControl(self.tbar_zoom_size)
        self.toolbar.AddSeparator()

        self.tbar_project_settings = wx.Button(
            self.toolbar, wx.ID_ANY, u"Settings...", wx.DefaultPosition, wx.DefaultSize, 0)
        self.toolbar.AddControl(self.tbar_project_settings)
        self.toolbar.AddSeparator()

        self.tbar_lock_bbox = wx.CheckBox(
            self.toolbar, wx.ID_ANY, u"Lock Table Bbox", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.ocr_edit_label = wx.StaticText(
            self, wx.ID_ANY, u"OCR/Ground-Truth Editor", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.ocr_reread_btn = wx.Button(
            self, wx.ID_ANY, u"Re-read OCR", wx.DefaultPosition, wx.DefaultSize, 0)
        self.ocr_reread_btn.Hide()
        self.ocr_reread_btn.SetToolTip(
            u"Click to re-read the OCR text extraction.")

        ocr_edit_label_sizer.Add(self.ocr_reread_btn, 0, wx.ALL, 5)

        self.ocr_lock_text = wx.CheckBox(
            self, wx.ID_ANY, u"Lock OCR/GT text", wx.DefaultPosition, wx.DefaultSize, 0)
        self.ocr_lock_text.Hide()

        ocr_edit_label_sizer.Add(self.ocr_lock_text, 0, wx.ALL, 5)

        self.ocr_edit_tip = wx.StaticText(
            self, wx.ID_ANY, u"Tip: Double-click cell to lock both OCR and NLP texts.", wx.DefaultPosition, wx.DefaultSize, 0)
        self.ocr_edit_tip.Wrap(-1)

        self.ocr_edit_tip.SetFont(wx.Font(wx.NORMAL_FONT.GetPointSize(
        ...
        self.nlpx_edit_label = wx.StaticText(
            self, wx.ID_ANY, u"NLP/Export Editor", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.nlpx_copy_ocr_text_btn = wx.Button(
            self, wx.ID_ANY, u"Copy OCR/GT Text", wx.DefaultPosition, wx.DefaultSize, 0)
        self.nlpx_copy_ocr_text_btn.Hide()

        nlpx_edit_label_sizer.Add(self.nlpx_copy_ocr_text_btn, 0, wx.ALL, 5)

        self.nlpx_lock_text = wx.CheckBox(
            self, wx.ID_ANY, u"Lock NLP/Export text", wx.DefaultPosition, wx.DefaultSize, 0)
        self.nlpx_lock_text.Hide()

        nlpx_edit_label_sizer.Add(self.nlpx_lock_text, 0, wx.ALL, 5)

        nlpx_tagChoices = [u"_NLP/Export tag",
                           u"Person", u"Role", u"Company", u"Software"]
        self.nlpx_tag = wx.Choice(
            self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, nlpx_tagChoices, wx.CB_SORT)
        ...
        self.nlpx_text_edit.SetFont(wx.Font(
            24, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
        ...
        # Connect Events
        self.Bind(wx.EVT_MENU, self.on_project_settings_click,
                  id=self.mnui_settings.GetId())
        self.Bind(wx.EVT_MENU, self.on_set_image_directory,
                  id=self.mnui_imgdir.GetId())
        ...
        self.Bind(wx.EVT_TOOL, self.on_tbar_tool_change,
                  id=self.tbar_row_sep.GetId())
        self.Bind(wx.EVT_TOOL, self.on_tbar_tool_change,
                  id=self.tbar_col_sep.GetId())
        self.Bind(wx.EVT_TOOL, self.on_tbar_tool_change,
                  id=self.tbar_del_sep.GetId())
        self.Bind(wx.EVT_TOOL, self.on_tbar_tool_change,
                  id=self.tbar_sel_cell.GetId())
        ...
        self.tbar_project_settings.Bind(
...
class FmtkTableMinerProjectDialog (wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"FmtkTableMiner Project Setup", pos=wx.DefaultPosition,
                           size=wx.Size(-1, -1), style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER | wx.TAB_TRAVERSAL)
        ...
        self.m_staticText11.SetFont(wx.Font(wx.NORMAL_FONT.GetPointSize(
        ), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_ITALIC, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString))
